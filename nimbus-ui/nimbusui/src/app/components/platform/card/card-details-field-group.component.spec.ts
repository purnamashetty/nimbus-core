...
describe('CardDetailsFieldGroupComponent', () => {
  ...
  it('getComponentClass() should return array [col-sm-6]',  async(() => {
      hostComponent.element.config.uiStyles.attributes.cssClass = null;
      hostComponent.element.config.uiStyles.attributes.cols = '2';
      expect(hostComponent.getComponentClass()).toEqual(['col-sm-6']);
  }));

  it('getComponentClass() should return array [col-sm-4]',  async(() => {
      hostComponent.element.config.uiStyles.attributes.cols = '3';
      expect(hostComponent.getComponentClass()).toEqual(['col-sm-4']);
  }));

  it('getComponentClass() should return array [col-sm-3]',  async(() => {
      hostComponent.element.config.uiStyles.attributes.cols = '4';
      expect(hostComponent.getComponentClass()).toEqual(['col-sm-3']);
  }));

  it('getComponentClass() should return array [col-sm-2]',  async(() => {
      hostComponent.element.config.uiStyles.attributes.cols = '6';
      expect(hostComponent.getComponentClass()).toEqual(['col-sm-2']);
  }));

  it('getComponentClass() should return array [col-sm-3] when cols is empty',  async(() => {
